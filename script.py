...
# 1- REALIZAR LA CARGA DE DATAFRAMES/DICCIONARIOS A MYSQL
#   1.1 - ¿CÓMO CONVERTIR EL DF DE SPARK EN UN ARCHIVO JSON/CSV/ETC PARA CARGARLO A MYSQL
#   1.2 - ¿CONVIENE CONVERTIR EL DF SPARK A DF DE PANDAS Y AHÍ SI CARGARLO?
